...
class ProductControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'product[createDate]' => 'Testing',
            'product[available]' => 'Testing',
            'product[theRange]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setAvailable('Value');
        $fixture->setTheRange('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'product[createDate]' => 'Something New',
            'product[available]' => 'Something New',
            'product[theRange]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getTheRange());
    }
